...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 1929514475792987436),
      name: 'LifeEvent',
      lastPropertyId: const IdUid(3, 7275119863799148307),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 6294852891485297992),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 8169552977946786679),
            name: 'title',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 7275119863799148307),
            name: 'count',
            type: 6,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 1929514475792987436),
